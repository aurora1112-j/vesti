...
平台标签色（浅底 + 深字）:
  ChatGPT:  bg #E8F5E9, text #2E7D32, border #C8E6C9
  Claude:   bg #FFF3E0, text #BF5B15, border #FFE0B2
  Gemini:   bg #E8EAF6, text #3949AB, border #C5CAE9
  DeepSeek: bg #E3F2FD, text #1565C0, border #BBDEFB
```
...
**Platform Tag（胶囊标签）：**
- `border-radius: 9999px`, `text-xs`(11px), `font-medium`
- padding: `2px 8px`
- 各平台使用专属 bg/text/border Token（见 3.2）

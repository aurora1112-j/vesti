...
export function ConversationList({
  ...
  return (
    <div className="flex flex-col gap-1 vesti-scroll overflow-y-auto px-4 pb-4">
      {grouped.map((group) => (
        <div key={group.label}>
          <h4 className="sticky top-0 z-10 bg-bg-tertiary pb-1 pt-3 text-vesti-xs font-medium text-text-tertiary">
            {group.label}
          </h4>

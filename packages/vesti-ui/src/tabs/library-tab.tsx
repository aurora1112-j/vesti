...
import type { Conversation, GardenerResult, Platform, Topic, StorageApi } from "../types";
...
export function LibraryTab({ storage }: LibraryTabProps) {
  const { getTopics, getConversations, runGardener } = storage;
